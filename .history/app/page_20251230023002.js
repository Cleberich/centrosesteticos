...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans">
      ...
      {/* Pricing Section */}
      <section
        className="py-24 px-4 bg-slate-50 dark:bg-slate-900/30"
        id="pricing"
      >
            ...
            {[
              {
                name: "Plan Basic",
                price: "Gratis",
                desc: "Para barberos que recién comienzan.",
                features: [
                  "Gestión de Agenda",
                  "Hasta 2 Barberos",
              ...
              },
              {
                name: "Plan Premium",
                price: "$15",
                desc: "Gestión total para tu local comercial.",
                features: [
                  "Barberos Ilimitados",
                  "Módulo de Contabilidad",
                  "Estadísticas Avanzadas",
                  "Reportes PDF",
                  "WhatsApp Marketing Manual",
                ],
                cta: "Obtener Premium",
                popular: true,
              },
              ...
              <div
                key={i}
                className={`rounded-3xl p-10 flex flex-col gap-8 relative transition-all border-2 ${
                  plan.popular
                    ? "border-blue-600 bg-white dark:bg-slate-900 shadow-2xl scale-105 z-10"
                    : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950"
                }`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em]">
                    Recomendado
                  </div>
                )}
                <div>
                ...
                <ul className="flex flex-col gap-4 text-sm font-bold text-slate-600 dark:text-slate-400 uppercase tracking-tight">
                ...
                <Link
                  href="/register"
                  className={`w-full rounded-xl h-14 flex items-center justify-center font-black uppercase tracking-widest text-xs transition-all ${
                    plan.popular
                      ? "bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-500/30"
                      : "border-2 border-slate-200 dark:border-slate-800 hover:border-blue-600 text-slate-900 dark:text-white"
                  }`}
                >
                  {plan.cta}
                </Link>
