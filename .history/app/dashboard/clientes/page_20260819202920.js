...
//       setIsEditOpen(false);
//     } catch (error) {
//       alert("Error al actualizar datos de la Cliente");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//                   Perfil de <span className="text-pink-500">Cliente</span>
//                 </h2>
//               </div>
//               <button
//                 onClick={() => setIsEditOpen(false)}
...
//               >
//                 <Save size={18} /> Actualizar Cliente
//               </button>
//             </form>
//           </div>
//         </div>
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F8FAFC] text-slate-800 font-sans antialiased overflow-y-auto">
      ...
      <header className="px-8 py-5 bg-white border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-30 shadow-xs">
        <div>
          <span className="text-[11px] font-semibold tracking-wider text-[#d87cef] uppercase">
            Directorio Medico
          </span>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#d87cef] hover:bg-[#d87cef] text-white px-4 py-2.5 rounded-xl text-xs font-medium transition-colors shadow-xs shrink-0"
          >
            <Plus size={16} />
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="text-[11px] font-semibold text-slate-400 border-b border-slate-100 bg-slate-50/30">
                  <th className="pl-6 py-3">Cliente</th>
                    ...
                    >
                      ...
                      <td className="pl-6 py-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-semibold text-slate-800 group-hover:text-[#d87cef] transition-colors">
                            {customer.name}
                          </span>
                        </div>
                      </td>
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl p-6 flex flex-col justify-between border-l border-slate-100">
            <div>
              ...
              >
                ...
                {/* Métricas rápidas de la Cliente dentro del Drawer */}
                {selectedCustomer && (
            ...
            <div className="pt-4 border-t border-slate-100">
              <button
                type="submit"
                form="patient-form"
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-[#d87cef] hover:bg-[#ce4eee] text-white rounded-xl text-xs font-medium transition-colors shadow-xs"
              >
                <Save size={15} />
