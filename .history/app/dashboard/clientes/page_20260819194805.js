        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <div className="relative flex-1 md:w-72">
            ...
            <input
              ...
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="w-full bg-slate-50 border border-slate-200/80 rounded-xl pl-9 pr-4 py-2 text-xs font-medium text-slate-800 placeholder-slate-400 outline-none focus:border-emerald-500 focus:bg-white transition-all"
            />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2.5 rounded-xl text-xs font-medium transition-colors shadow-xs shrink-0"
          >
            <Plus size={16} />
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl p-6 flex flex-col justify-between border-l border-slate-100">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200/80 rounded-xl pl-10 pr-3.5 py-2 text-xs font-medium text-slate-800 outline-none focus:border-emerald-500 focus:bg-white transition-all"
            ...
            <div className="pt-4 border-t border-slate-100">
              <button
                type="submit"
                form="patient-form"
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-xs font-medium transition-colors shadow-xs"
              >
                <Save size={15} />
