              ...
              {barberiaData?.useAccountingPin && (
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800 border-2 border-dashed border-blue-500/30 rounded-2xl py-4 px-2 text-center text-xl font-black tracking-[1em] text-blue-600 dark:text-blue-400 outline-none focus:border-blue-500"
                  />
