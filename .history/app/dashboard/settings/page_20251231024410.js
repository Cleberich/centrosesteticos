      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/30">
            <label className="text-[10px] font-black uppercase text-blue-600 dark:text-blue-400 ml-2 tracking-widest flex items-center gap-2 mb-2">
              <Navigation size={14} /> Link Exacto de Google Maps
            </label>

            <div className="space-y-3">
              <input
                placeholder="Pegue aquí el link (ej: https://maps.app.goo.gl/...)"
                value={barberiaData?.mapsLink || ""}
                onChange={(e) =>
                  setBarberiaData({ ...barberiaData, mapsLink: e.target.value })
                }
                className="w-full bg-white dark:bg-slate-800 p-4 rounded-xl font-bold text-blue-500 outline-none border-2 border-blue-200 dark:border-slate-700 focus:border-blue-500 transition-all"
              />
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 px-2">
                <p className="text-[9px] text-slate-500 font-bold uppercase leading-tight">
                  <span className="text-blue-600">¿Cómo obtenerlo?</span> 1.
                  Busca tu local en Google Maps <br />
                  2. Toca en "Compartir" y luego en "Copiar enlace".
                </p>
                ...
                <button
                  ...
                  onClick={() => {
                    if (barberiaData?.direccion) {
                      ...
                      alert(
                        "Escribe primero el nombre o dirección arriba para buscar"
                      );
                    }
                  }}
                  className="flex items-center gap-2 bg-slate-900 dark:bg-slate-700 text-white px-4 py-2 rounded-lg font-black text-[9px] uppercase hover:bg-blue-600 transition-colors"
                >
                  <MapPin size={12} /> Abrir Maps para buscar
                </button>
              </div>
            </div>
          </div>
