...
function SettingsContent() {
  ...
  const handleTogglePinProtection = () => {
    if (barberiaData?.useAccountingPin) {
      setIsVerifyModalOpen(true); // Si está activo, pedimos PIN para apagar
    } else {
      setBarberiaData({
        ...barberiaData,
        useAccountingPin: true,
        adminPin: "",
      }); // Si está apagado, lo prendemos y limpiamos pin anterior
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-12 pb-32 font-sans transition-colors">
      <div className="max-w-5xl mx-auto space-y-10">
        <header className="flex justify-between items-end">
          <div>
        ...
        <section className="flex flex-col md:flex-row items-center gap-8 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="relative group">
            ...
            <label className="absolute bottom-0 right-0 bg-blue-600 p-3 rounded-full text-white cursor-pointer shadow-lg">
              <Camera size={20} />
              <input
                type="file"
                className="hidden"
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-500 text-xs font-bold uppercase mt-1">
              Identidad de tu barbería
            </p>
          </div>
        </section>

        {/* SECCIÓN SEGURIDAD ANTI-INSPECCIÓN */}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h3 className="flex items-center gap-2 font-black uppercase text-xs text-blue-600 tracking-widest italic">
                <ShieldCheck size={18} /> Protección de Finanzas
              </h3>
              <p className="text-[10px] text-slate-500 font-bold uppercase mt-1">
                Bloquea la contabilidad con un código
              </p>
            </div>
            <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              {barberiaData?.useAccountingPin && (
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800 border-2 border-dashed border-blue-500/30 rounded-2xl py-4 px-6 text-center text-xl font-black tracking-[1em] text-blue-600 dark:text-blue-400 outline-none focus:border-blue-500"
                  />
                  <p className="text-[9px] text-center font-black text-slate-400 uppercase tracking-widest">
                    El PIN se oculta automáticamente por seguridad
                  </p>
                </div>
              )}
            </div>
            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-3xl border dark:border-slate-700">
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold leading-relaxed uppercase">
                Para evitar que el PIN sea visto mediante herramientas de
                desarrollador, el campo está configurado como "Secure Hidden".
                El sistema no permite previsualizar el código una vez escrito.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
            <div className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2.5rem] shadow-2xl p-8 border dark:border-slate-800 text-center">
              ...
              <p className="text-slate-500 text-[10px] font-bold uppercase mt-1 mb-6">
                Ingresa el PIN actual para desactivar
              </p>
              ...
              <form onSubmit={confirmDeactivation} className="space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 py-4 bg-red-600 text-white rounded-xl font-black text-[10px] uppercase shadow-lg"
                  >
                    Confirmar
                  </button>
                </div>
              ...
              <button
                ...
                onClick={() => {
                  const msg = encodeURIComponent(
                    `¡Hola! Reservá online aquí: https://barberias.vercel.app/reserva/${auth.currentUser?.uid}`
                  );
