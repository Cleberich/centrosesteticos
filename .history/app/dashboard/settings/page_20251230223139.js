  ...
  return (
    <div className="min-h-screen overflow-scroll bg-slate-50 dark:bg-slate-950 p-6 md:p-12 pb-32 font-sans transition-colors">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* --- NUEVA SECCIÓN: SEGURIDAD Y CONTABILIDAD CON PIN --- */}
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div
              onClick={() =>
                setBarberiaData({
                  ...barberiaData,
                  useAccountingPin: !barberiaData?.useAccountingPin,
                })
              }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-blue-50/50 dark:bg-blue-900/10 p-6 rounded-3xl border border-blue-100 dark:border-blue-900/30">
              <h4 className="text-[10px] font-black uppercase text-blue-600 mb-2 tracking-widest flex items-center gap-2">
                <ExternalLink size={14} /> Importancia del PIN
              </h4>
              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold leading-relaxed uppercase">
                Si habilitas esta opción, se pedirá un código de acceso cada vez
                que alguien intente entrar a la sección de "Contabilidad". Ideal
                si compartes la tablet o PC con tus barberos y no quieres que
                vean los ingresos totales del local.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-2">
              <button
                ...
                className="flex-1 md:flex-none bg-slate-900 dark:bg-slate-800 text-white px-6 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:opacity-90 transition-all"
              >
                Copiar
              </button>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-emerald-500 text-white px-6 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg"
              >
