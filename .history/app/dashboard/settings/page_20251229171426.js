    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-12 pb-32">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
          <h3 className="flex items-center gap-2 font-black uppercase text-xs text-blue-600 mb-4 italic">
            <LinkIcon size={16} /> Link Público de Reservas
          </h3>
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1 bg-slate-50 dark:bg-slate-800 p-4 rounded-xl font-bold text-xs truncate border dark:border-slate-700 dark:text-blue-400">
            ...
            {planes.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-xl font-black dark:text-white uppercase italic tracking-tighter">
                    {p.name}
                  </h4>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <section className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
            <h3 className="flex items-center gap-2 font-black uppercase text-xs text-slate-400 mb-8 italic">
