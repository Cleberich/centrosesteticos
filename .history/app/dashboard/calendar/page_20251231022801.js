      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end items-end md:items-stretch">
          <div
            ...
            onClick={() => setIsDrawerOpen(false)}
          />
          <div className="relative mt-24 w-full md:max-w-[450px] bg-white dark:bg-red-900 h-[95vh] md:h-full rounded-t-[2.5rem] md:rounded-none flex flex-col p-6 md:p-8 overflow-y-auto">
            <div className="w-12 h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full mx-auto mb-6 md:hidden" />
