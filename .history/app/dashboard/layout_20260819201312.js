...
//             <div className="w-6 h-6 rounded-md bg-[#4ADE80] flex items-center justify-center text-slate-900 font-bold text-xs shadow-xs">
//               ✦
//             </div>
...
//           </p>
//           <button className="w-full py-2 bg-[#4ADE80] hover:bg-[#22C55E] text-slate-900 font-bold text-[10px] rounded-xl transition-colors shadow-xs">
//             Explore the Updates!
//           </button>
//         </div>
...
//             <div className="w-5 h-5 rounded-md bg-[#4ADE80] flex items-center justify-center text-slate-900 font-bold text-[10px]">
//               ✦
//             </div>
