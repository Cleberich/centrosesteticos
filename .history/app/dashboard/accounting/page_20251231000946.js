...
export default function AccountingPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8fafc] dark:bg-[#0a0f1a] p-6 lg:p-10 overflow-y-auto">
      ...
      {/* KPIs */}
      <div className="mb-8">
        {/* Contenedor con Scroll Lateral en Mobile, Grid en Desktop */}
        <div className="flex overflow-x-auto md:grid md:grid-cols-3 gap-6 pb-4 md:pb-0 snap-x snap-mandatory scrollbar-hide">
          {/* Card 1 */}
        ...
        {/* Indicador visual de scroll solo en Mobile */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          {/* VISTA DESKTOP: Tabla original (se oculta en mobile) */}
          ...
          {/* VISTA MOBILE: Tarjetas optimizadas (se oculta en desktop) */}
            ...
            {accountingData.stats.map((b, i) => (
              <div key={i} className="p-6 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-base font-black dark:text-white uppercase italic tracking-tight">
                    {b.name}
                  </span>
                  <span className="bg-blue-100 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-[10px] font-black px-3 py-1 rounded-full uppercase">
        ...
        {/* SECCIÓN RENTABILIDAD: Ajustada para mejor visualización en ambos */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 flex flex-col items-center justify-center text-center h-fit shadow-sm">
          <div className="size-16 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center text-blue-600 mb-4 shadow-inner">
            <TrendingUp size={28} strokeWidth={3} />
          </div>
          <h3 className="text-lg font-black dark:text-white uppercase tracking-tight italic">
            Rentabilidad
          </h3>
          <p className="text-[10px] font-bold text-slate-500 uppercase mb-6 leading-tight max-w-[200px]">
            Tu porcentaje de ganancia real después de comisiones.
          </p>
...
function KpiCard({ label, value, icon, color }) {
  ...
  return (
    <div className="bg-white pb-96 dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:scale-[1.02]">
      <div className={`p-2.5 rounded-xl inline-block mb-4 ${colors[color]}`}>
        {icon}
      </div>
