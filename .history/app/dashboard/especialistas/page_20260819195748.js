...
export default function SpecialistsByutiePage() {
  ...
  return (
    <div className="flex h-screen bg-[#FAF8F5] text-slate-700 font-sans antialiased overflow-hidden">
      {/* 1. SIDEBAR LEFT (Exacta al UI Kit Byutie) */}
      <aside className="w-64 bg-[#FAF8F5] border-r border-slate-200/60 flex flex-col justify-between p-6 shrink-0">
        <div className="space-y-8">
          {/* Logo */}
          <div className="flex items-center gap-2.5 px-2">
            <div className="w-6 h-6 rounded-md bg-[#4ADE80] flex items-center justify-center text-white font-bold text-xs">
              ✦
            </div>
          ...
          <nav className="space-y-1">
            {[
              ...
              { label: "Doctors", icon: UserCheck, active: true },
              { label: "Appointments", icon: Calendar, active: false },
              { label: "Surgery Schedule", icon: Clock, active: false },
              { label: "Treatments", icon: Sparkles, active: false },
                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon
                      size={16}
                      className={
                        item.active ? "text-[#15803D]" : "text-slate-400"
                      }
                    />
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gradient-to-br from-[#FFE4E6] to-[#FED7AA] rounded-2xl space-y-3">
            ...
            <button className="w-full py-2 bg-[#4ADE80] text-slate-900 font-bold text-[10px] rounded-xl hover:bg-[#22C55E] transition-colors shadow-xs">
              Explore the Updates!
            </button>
          </div>

          <button className="flex items-center gap-2.5 text-slate-400 hover:text-slate-700 text-xs font-semibold px-2 py-1 transition-colors">
            <LogOut size={16} />
            <span>Logout</span>
          </button>
        </div>
