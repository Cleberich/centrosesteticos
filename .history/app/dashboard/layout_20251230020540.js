        ...
        <div className="flex flex-col h-full justify-between">
          <div className="space-y-8">
            <div className="flex items-center gap-3 px-2">
              <div className="size-12 rounded-full border-2 border-blue-600 bg-slate-100 dark:bg-slate-800 flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                {loading ? (
          ...
          <div className="space-y-1 pt-6 border-t border-slate-100 dark:border-slate-800">
            ...
            <div
              ...
              className="flex items-center justify-between px-3 py-3 rounded-xl transition-all font-medium text-sm cursor-pointer text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 mb-2"
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold tracking-tight dark:text-slate-200">
