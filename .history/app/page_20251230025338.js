        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-12 lg:py-24">
          <div className="flex flex-col-reverse lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 relative px-4 sm:px-0">
              ...
              <div className="absolute w-full aspect-square sm:aspect-[4/3] bg-[url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?auto=format&fit=crop&q=80')] bg-center bg-cover rounded-3xl shadow-2xl border-4 sm:border-8 border-white dark:border-slate-900">
                <div className="absolute -bottom-4 -right-4 sm:top-6 sm:-left-6 bg-white dark:bg-slate-800 p-3 sm:p-4 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700">
