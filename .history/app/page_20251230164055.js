...
//             >
//               <span className="text-lg sm:text-xl flex items-center gap-2 font-black uppercase tracking-tighter italic">
...
//         <div
//           className={`fixed inset-0 top-[65px] z-40 bg-white dark:bg-slate-950 transition-transform duration-300 ease-in-out md:hidden ${
...
//             <span className="text-xl flex items-center gap-2 font-black uppercase italic">
//               Agenda <Scissors size={24} className="text-blue-600" /> Barber
//             </span>
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans">
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-12 items-center">
            <div className="flex flex-col gap-6 lg:w-1/2 text-center lg:text-left">
              <div className="inline-flex mx-auto lg:mx-0 w-fit items-center gap-2 rounded-full bg-slate-100 dark:bg-slate-800 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-blue-600">
                ...
                Impulsado por Marketing Inteligente
              </div>
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black leading-tight sm:leading-[0.9] tracking-tighter uppercase italic">
                No solo agendas,{" "}
                <span className="text-blue-600">Vendes más</span>
              </h1>
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium">
                La plataforma que recupera clientes perdidos, premia la lealtad
                y profesionaliza tu barbería de forma automática.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center lg:justify-start">
                <Link
                  href="/register"
            ...
            <div className="w-full lg:w-1/2 relative px-4 sm:px-0">
              <div className="absolute -inset-4 sm:-inset-10 bg-blue-600/10 rounded-full blur-3xl"></div>
              <div className="relative w-full aspect-square sm:aspect-[4/3] bg-[url('https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&q=80')] bg-center bg-cover rounded-3xl shadow-2xl border-4 sm:border-8 border-white dark:border-slate-900">
                {/* Flotante de Notificación de Marketing */}
                <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 animate-bounce">
                  <div className="flex items-center gap-3">
      ...
      {/* Marketing Tools Section (NUEVA) */}
      <section
        className="py-16 sm:py-24 px-6 bg-slate-900 text-white overflow-hidden"
        id="marketing"
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <h3 className="text-3xl sm:text-5xl font-black uppercase italic tracking-tighter leading-none mb-8">
                Funciones de <span className="text-blue-500">Marketing</span>{" "}
                Integradas
              </h3>

              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="shrink-0 size-12 rounded-2xl bg-blue-600 flex items-center justify-center">
                    <Zap size={24} />
                  </div>
                  <div>
                    ...
                    <p className="text-slate-400 text-sm font-medium">
                      El sistema detecta clientes que no vuelven hace 21 días y
                      genera un recordatorio automático por WhatsApp.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="shrink-0 size-12 rounded-2xl bg-emerald-500 flex items-center justify-center">
                    <Award size={24} />
                  </div>
                  <div>
                    <h4 className="font-black uppercase italic text-lg tracking-tight">
                    ...
                    <p className="text-slate-400 text-sm font-medium">
                      Tarjeta de sellos virtual. Premia a tus clientes
                      frecuentes con un corte gratis después de N visitas.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="shrink-0 size-12 rounded-2xl bg-purple-500 flex items-center justify-center">
                    <Star size={24} />
                  </div>
                  <div>
                    <h4 className="font-black uppercase italic text-lg tracking-tight">
                    ...
                    <p className="text-slate-400 text-sm font-medium">
                      Muestra tus mejores trabajos directamente en tu link de
                      reserva para aumentar la confianza.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2 relative">
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-[3rem] border border-white/10 shadow-2xl">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="size-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-500 font-black text-[10px]">
                        JS
                      </div>
                      <span className="text-xs font-bold">
                        Juan Sanchez -{" "}
                        <span className="text-slate-500">Hace 25 días</span>
                      </span>
                    </div>
                    <button className="px-3 py-1 bg-blue-600 rounded-lg text-[9px] font-black uppercase">
                      Recuperar
                    </button>
                  </div>
                  <div className="p-4 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-between opacity-50">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold">
                        Mario Aris -{" "}
                        <span className="text-slate-500">Hace 22 días</span>
                      </span>
                    </div>
                    <button className="px-3 py-1 bg-blue-600 rounded-lg text-[9px] font-black uppercase">
                      Recuperar
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col gap-8 text-center md:text-left">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">
              © 2025 AgendaBarber. El arte de gestionar bien.
            </p>
          </div>
        </div>
      </footer>
