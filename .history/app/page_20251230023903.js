          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-center">
            {[
              ...
              },
              {
                ...
                cta: "Elegir",
                popular: true, // Marcamos como el más elegido
                icon: (
                  <Star
                    size={20}
              ...
              <div
                key={i}
                className={`rounded-[2.5rem] p-8 flex flex-col gap-6 transition-all duration-300 border-2 bg-white dark:bg-[#0a1120] ${
                  plan.popular
                    ? "border-blue-600 shadow-2xl shadow-blue-500/20 scale-105 z-10 py-10"
                    : "border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 shadow-sm"
                } ${plan.name === "Free" ? "opacity-70 italic" : ""}`}
              >
                {plan.popular && (
                ...
                <ul className="flex flex-col gap-4 mt-2">
                  {plan.features.map((f, j) => (
                    <li
                      key={j}
                      className="flex items-center gap-3 text-[11px] font-black uppercase tracking-tight text-slate-500 dark:text-slate-300"
                    >
                      <div className="size-5 shrink-0 rounded-full border-2 border-green-500/50 flex items-center justify-center text-green-500">
                ...
                <button
                  className={`w-full rounded-2xl h-14 mt-auto font-black uppercase tracking-[0.2em] text-xs transition-all ${
                    plan.name === "Free"
