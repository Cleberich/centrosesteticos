        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-500 font-medium">
              Comienza gratis y escala según crezca tu equipo.
            </p>
          </div>
            ...
            {[
              {
                name: "Free",
                price: "$0",
                desc: "Plan inicial limitado",
                features: ["1 Barbero", "20 Reservas/mes", "Agenda Básica"],
                cta: "Tu Plan Actual",
                color: "slate",
                icon: <User size={20} />,
              },
              {
                name: "Básico",
                price: "$690",
                desc: "Ideal para independientes",
              ...
              <div
                key={i}
                className={`rounded-[2.5rem] p-8 flex flex-col gap-6 transition-all border-2 bg-white dark:bg-[#0a0f1a] ${
                  plan.name === "Free"
                    ? "border-slate-200 dark:border-slate-800 opacity-80"
                    : "border-slate-200 dark:border-slate-800 hover:border-blue-600 shadow-sm"
                }`}
              >
                ...
                <ul className="flex flex-col gap-4 mt-2">
                  {plan.features.map((f, j) => (
                    <li
                      key={j}
                      className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-tight text-slate-500 dark:text-slate-400"
                    >
                      <div className="size-5 rounded-full border-2 border-green-500/50 flex items-center justify-center text-green-500">
                ...
                <button
                  className={`w-full rounded-2xl h-14 mt-auto font-black uppercase tracking-widest text-xs transition-all ${
                    plan.name === "Free"
