          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            {[
              ...
              >
                ...
                <button className="w-full rounded-2xl h-14 font-black uppercase tracking-[0.2em] text-xs transition-all bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-500/30 active:scale-95">
                  {plan.cta}
                </button>
              </div>
            ))}
