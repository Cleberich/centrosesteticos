  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm">
        ...
        <div
          className={`fixed inset-0 top-[65px] h-80 z-40 bg-white dark:bg-slate-900 transition-transform duration-300 ease-in-out md:hidden ${
        ...
        >
          <nav className="flex flex-col p-6 gap-6 text-center">
            <a
              onClick={closeMenu}
              className="text-md font-black uppercase  border-b border-slate-100 dark:border-slate-800 pb-4"
              href="#features"
            >
              Funcionalidades
            </a>
            ...
            <Link
              onClick={closeMenu}
              href="/register"
              className="mt-4 flex items-center justify-center rounded-2xl h-16 bg-blue-600 text-white text-lg font-black uppercase  tracking-widest"
            >
              Empezar Ahora
            </Link>
          </nav>
