  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-slate-100 font-sans selection:bg-blue-500/30">
      ...
      <main className="max-w-4xl mx-auto p-6 md:p-10">
              ...
              <div className="space-y-6">
                <div className="bg-slate-900/40 p-8 rounded-[2.5rem] border border-white/5 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <select
                      className="w-full bg-slate-800/50 border border-white/5 rounded-2xl py-4 px-5 text-xs font-bold uppercase outline-none cursor-pointer appearance-none text-slate-300"
                      onChange={(e) => {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {availableSlots.length > 0 ? (
                      ...
                      <div className="col-span-3 py-8 text-center bg-slate-800/20 rounded-2xl border border-dashed border-white/10">
        ...
        {/* STEP 3: SUCCESS */}
        {step === 3 && (
          <div className="max-w-md mx-auto text-center py-20 animate-in zoom-in-95 duration-700">
            ...
            <button
              ...
              className="mt-10 px-8 py-4 bg-slate-800 rounded-full text-[10px] font-black text-slate-300 uppercase tracking-widest hover:bg-slate-700 transition-all"
            >
              Hacer otra reserva
            </button>
          </div>
