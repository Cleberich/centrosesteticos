            ...
            <div className="flex flex-col gap-3 mt-8">
              ...
              {(barberia?.mapsLink || barberia?.direccion) && (
                <a
                  ...
                  className="w-full py-4 bg-yellow-600/10 border border-blue-500/20 rounded-full text-[10px] font-black text-yellow-400 uppercase tracking-widest hover:bg-blue-600/20 transition-all flex items-center justify-center gap-2"
                >
                  <MapPin size={14} />
                  Ver cómo llegar
                </a>
