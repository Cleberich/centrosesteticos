      ...
      <main className="max-w-4xl mx-auto p-6 md:p-10">
        ...
        {step === 3 && (
          <div className="max-w-md mx-auto text-center py-10 animate-in zoom-in-95 duration-700">
            ...
            {/* SECCIÓN: DIRECCIÓN Y TELÉFONO DEL LOCAL */}
            ...
            <div className="flex flex-col gap-3 mt-8">
              {/* BOTÓN DE GOOGLE MAPS: Prioriza el Link Directo, luego la Dirección escrita */}
              {(barberia?.mapsLink || barberia?.direccion) && (
                <a
                  href={
                    barberia?.mapsLink
                      ? barberia.mapsLink
                  ...
                  className="w-full py-4 bg-yellow-600/40 border border-blue-500/20 rounded-full text-[10px] font-black text-yellow-400 uppercase tracking-widest hover:bg-blue-600/20 transition-all flex items-center justify-center gap-2"
                >
                  <MapPin size={14} />
                  Ver cómo llegar
                </a>
