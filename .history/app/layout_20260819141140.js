...
export const metadata = {
  title: {
    default: "AppEstetica | Gestión y Agenda para Centros de Belleza",
    template: "%s | AppEstetica",
  },
  description:
    "AppEstetica es la plataforma integral para gestionar turnos, tratamientos, fichas de pacientes y estadísticas de tu centro de estética o spa. Profesionaliza tu servicio hoy.",
  keywords: [
    "AppEstetica",
  ...
  authors: [{ name: "AppEstetica Team" }],
  creator: "AppEstetica",
  publisher: "AppEstetica",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    title: "AppEstetica | Gestión y Agenda Profesional para Estética y Spa",
    description:
  ...
  twitter: {
    ...
    title: "AppEstetica | Software para Centros de Belleza",
