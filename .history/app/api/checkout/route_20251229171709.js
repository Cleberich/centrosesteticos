      ...
      "https://api.mercadopago.com/checkout/preferences",
      {
        ...
        body: JSON.stringify({
          ...
          back_urls: {
            ...
            success: `https://finanzas-aldia.vercel.app/dashboard/settings?plan=${planId}`,
            failure:
              "https://finanzas-aldia.vercel.app/dashboard/settings?status=failed",
            pending:
              "https://finanzas-aldia.vercel.app/dashboard/settings?status=pending",
          },
          auto_return: "approved",
